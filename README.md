...
The bigIRT package was used to derive the word difficulty indices, and the codes for doing so are available in RMarkdown.

## 4. Flemma list with Japanese EFL word difficulty indices
The list of the resulting 2999 flemmas along with their difficulty estimates for L1 Japanese EFL learners are available in .xlxs format and [Google Sheets](https://docs.google.com/spreadsheets/d/1R6-LhHi5JdgMjFsqLMe_Gp9CBoKmrA_yOj7-SHZG-fM/edit?gid=0#gid=0).
